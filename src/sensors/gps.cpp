//Sensor de GPS
//Esperar 15min pra ele funcionar(Pegar o FIX). Depois que ele funciona pela primeira vez, a espera é mais rapida
//Ordem da pinagem: GND, VCC, RX, TX (Diferente do que ta escrito)
#include "gps.h"
TinyGPSPlus gps;
